...
SWIFT_CLASS("_TtC15TestCoreDataApp11AppDelegate")
...
SWIFT_CLASS("_TtC15TestCoreDataApp13TableViewCell")
...
- (IBAction)addNameBarButton:(id _Nonnull)sender;
- (void)saveName:(NSString * _Nullable)name;
- (void)fetchLog;
